...
const FormBox = styled.div(mediaquery({
  ...
  '& label': {
    ...
    padding: ['1em', '1em', '1em', '1.5em', '1.5em 0.5em'],
    color: `${colors.gray_text}`,
    fontSize: ['0.7em', '0.7em', '0.8em', '0.9em', '1em'],
    fontWeight: '500',
    textAlign: ['center', 'center', 'center', 'left', 'left'],
  },
  '& input': {
    width: ['90%', '90%', '95%', '60%', '60%'],
    height: ['4em', '4em', '3.5em', '3.5em', '4em'],
    padding: '1em',
    margin: 0,
    border: '1px solid #eee',
    borderRadius: '0.5em',
    color: `${colors.gray_text01}`,
    fontSize: ['0.6em', '0.6em', '0.7em', '0.9em', '0.9em'],
    outlineStyle: 'none',
...
const Button = styled.button(mediaquery({
  ...
  fontSize: ['0.8em', '0.8em', '1em', '1.1em', '1.3em'],
  fontWeight: '500',
  cursor: 'pointer',
  letterSpacing: '0.2em',
  '&:hover': {
