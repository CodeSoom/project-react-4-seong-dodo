...
const FormBox = styled.div(mediaquery({
  ...
  '& label': {
    ...
    width: ['100%', '100%', '100%', '30%', '20%'],
    padding: ['1em', '1em', '1em', '1.5em', '.5em'],
    color: `${colors.gray_text}`,
    fontSize: ['0.7em', '0.7em', '0.8em', '1em', '.9em'],
    fontWeight: '600',
    textAlign: ['left', 'center', 'center', 'center', 'center'],
  },
  '& input': {
    width: ['95%', '95%', '95%', '65%', '70%'],
    height: ['3em', '4em', '3.5em', '3.5em', '3em'],
    // padding: '.2em .5em',
...
const Button = styled.button(mediaquery({
  ...
  fontSize: ['0.9em', '0.9em', '1em', '1.1em', '1em'],
  fontWeight: '500',
  cursor: 'pointer',
  '&:hover': {
    color: `${colors.white}`,
